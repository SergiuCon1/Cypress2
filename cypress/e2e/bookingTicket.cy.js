...
const { daysOfWeek, movieSeance, acceptionButton } = require('../fixtures/cinemaHallSelectors.json')
...
describe("The user can booking the ticket", () => {
  ...
  it("User have possible to booking the ticket", () => {
    ...
    seats.forEach((element) => {
      cy.get(`.buying-scheme__wrapper > :nth-child(${element.row}) > :nth-child(${element.seat})`).click();
    })
